...
DATA_IN_PATH = "/Users/dhkim/gh/NLP_basic/nlp_DL/data_in/"
DATA_OUT_PATH = "/Users/dhkim/gh/NLP_basic/nlp_DL/data_out/"
...
decoder = Decoder(vocab_size, 64, 128, 2)
dec_hidden = enc_hidden

predict_tokens = []

for t in range(index_outputs.shape[1]):
    dec_input = tf.dtypes.cast(tf.expand_dims(index_outputs[:, t], 1), tf.float32)
